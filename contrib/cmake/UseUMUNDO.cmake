...
if (NOT CMAKE_CROSSCOMPILING AND CMAKE_PROJECT_NAME MATCHES "umundo")
	if (WIN32)
		set(UMUNDO_PROTOBUF_CPP_RPC_EXECUTABLE "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/protoc-umundo-cpp-rpc.exe" PARENT_SCOPE)
		set(UMUNDO_PROTOBUF_JAVA_RPC_EXECUTABLE "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/protoc-umundo-java-rpc.exe" PARENT_SCOPE)
	else()
		set(UMUNDO_PROTOBUF_CPP_RPC_EXECUTABLE "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/protoc-umundo-cpp-rpc" PARENT_SCOPE)
		set(UMUNDO_PROTOBUF_JAVA_RPC_EXECUTABLE "${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/protoc-umundo-java-rpc" PARENT_SCOPE)
	endif()
