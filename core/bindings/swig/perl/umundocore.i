...
# else
%module(directors="1", allprotected="1") umundoNativePerl64
#	endif
#else
#	ifdef DEBUG
%module(directors="1", allprotected="1") umundoNativePerl_d
#	else
%module(directors="1", allprotected="1") umundoNativePerl
#	endif
#endif
...
// Provide a nicer Perl interface to STL containers
...
// allow Perl classes to act as callbacks from C++
